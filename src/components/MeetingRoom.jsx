...
import React, { useState, useEffect, useRef, useCallback } from "react";
import io from "socket.io-client"; // यह import आवश्यक है
import {
  getMeetingDetails,
  processTranscriptForMeeting,
  generateAgendaForMeeting,
...
// सिर्फ इस लाइन को बदलें:
// const SOCKET_SERVER_URL = "http://localhost:3001"; // पुरानी लाइन
const SOCKET_SERVER_URL =
  import.meta.env.VITE_SOCKET_SERVER_URL || "http://localhost:3001"; // नई लाइन
...
const MeetingRoom = ({ meetingId, onLeaveMeeting }) => {
  ...
  useEffect(() => {
    ...
    // यह सुनिश्चित करने के लिए एक console.log जोड़ें कि सही URL का उपयोग किया जा रहा है
    console.log("Attempting to connect Socket.IO to:", SOCKET_SERVER_URL);

    socketRef.current = io(SOCKET_SERVER_URL, {
      // यदि कनेक्शन में समस्या आ रही है, तो आप transports को स्पष्ट रूप से परिभाषित करने का प्रयास कर सकते हैं:
  ...
  }, [meetingId, loadMeetingDetails]); // SOCKET_SERVER_URL को यहां निर्भरता के रूप में जोड़ने की आवश्यकता नहीं है
  // क्योंकि यह मॉड्यूल स्तर पर परिभाषित है और बदलता नहीं है।

  // ... बाकी सभी हैंडलर फंक्शन्स और JSX वैसे ही रहेंगे ...
          ...
          <div className="transcript-box">
            ...
            {transcript.map((entry, index) => (
              <div
                key={index}
                className={`transcript-entry ${
                  entry.speaker === "Alice" ? "speaker-alice" : "speaker-other"
                }`}
              >
                <div className="transcript-bubble">
                  <p className="transcript-speaker-info">
